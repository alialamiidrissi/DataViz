/**
  Disclaimer: This code was adapted from the chartjs plugin for stacked bars.
  Refer to https://github.com/y-takey/chartjs-plugin-stacked100 for more information.
**/
...
(function(Chart) {
  ...
  var Stacked100Plugin = {
    ...
    beforeInit: function(chartInstance, pluginOptions) {
      ...
      // if (!pluginOptions || !pluginOptions.enable) return;
      if(!chartInstance.config.options.plugins || !chartInstance.config.options.plugins.stacked100) return;
